...
export const TrendingGamesSection: React.FC<TrendingGamesSectionProps> = ({
  ...
  return (
    <section id="play369-trending-games-section" className="space-y-2.5 sm:space-y-3" aria-label="Trending Games">
      {/* Header */}
          ...
          {trendingGames.map((game) => {
            ...
            return (
              <div
                ...
                className="group relative w-28 xs:w-32 sm:w-36 rounded-2xl overflow-hidden bg-[#02180e] border border-emerald-800/60 hover:border-amber-400/80 shadow-md transition-all cursor-pointer select-none active:scale-[0.98] flex flex-col justify-between"
                role="button"
                tabIndex={0}
              ...
              >
                ...
                <div className="relative aspect-square w-full overflow-hidden bg-emerald-950/30">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#02180e] via-transparent to-transparent opacity-75" />
                  ...
                  {onToggleFavorite && (
                    <button
                      ...
                      className="absolute top-1.5 right-1.5 p-1 rounded-full bg-black/40 hover:bg-black/70 text-slate-300 hover:text-rose-400 transition-colors backdrop-blur-xs min-h-[32px] min-w-[32px] flex items-center justify-center cursor-pointer"
                ...
                {/* Title & Provider */}
                <div className="p-1.5 sm:p-2 bg-[#02180e] border-t border-emerald-900/40">
                  <h4 className="font-bold text-[11px] sm:text-xs text-white group-hover:text-amber-300 transition-colors truncate">
                    {game.name}
                  </h4>
