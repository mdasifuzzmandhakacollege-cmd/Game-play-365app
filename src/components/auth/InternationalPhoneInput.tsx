              ...
              <div className="relative">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 text-emerald-500 hover:text-emerald-300"
                  >
                ...
                filteredCountries.map((country) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full min-h-[44px] px-3.5 py-2 flex items-center justify-between text-left transition-colors cursor-pointer ${
                        isSelected
                    ...
                    >
                      <div className="flex items-center space-x-2.5 truncate">
                        ...
                        <span className="text-[10px] text-emerald-500/80 font-mono">({country.code})</span>
                      </div>
